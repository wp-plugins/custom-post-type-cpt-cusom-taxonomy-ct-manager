...
function rt_create_menu(){
    ...
    $rtmanager = add_menu_page( __( 'rtManager','cpt-ct' ), __( 'rtManager','cpt-ct' ), 'administrator', 'rtm', 'rtm_front_page', plugins_url('cpt-ct-manager/images/icon.ico') );
    add_submenu_page( 'rtm', __( 'Create CPT','cpt-ct' ), __('Create Custom Post Type','cpt-ct'), 'administrator', 'rtm-create-cpt', 'rtm_create_post_type' );
    add_submenu_page( 'rtm', __('Create CT','cpt-ct'),  __('Create Custom Taxonomy','cpt-ct'), 'administrator', 'rtm-create-ct', 'rtm_create_taxonomy' );
