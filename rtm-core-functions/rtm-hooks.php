...
function rt_add_styles_and_scripts(){
    wp_enqueue_script( 'rtm', plugin_dir_url().'custom-post-type-cpt-cusom-taxonomy-ct-manager/js/rtm.js', array(), false, true );
    
    wp_enqueue_style('rtm-style', plugin_dir_url().'custom-post-type-cpt-cusom-taxonomy-ct-manager/styles/rtm-style.css');
}
